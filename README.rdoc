...
controller in applications using Clearance[https://github.com/thoughtbot/clearance]
...
as when logging in the browser, you should be in:
    ...
    $ curl -i -X GET -u test@example.com:password http://localhost:3000/resources.xml
